...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appBarConfig = AppBarConfiguration(setOf(R.id.mainFragment, R.id.scrollFragment, R.id.profileFragment, R.id.settingsFragment))
        setupActionBarWithNavController(navController, appBarConfig)

        navMenu.setupWithNavController(navController)
        initScores()

        navMenu.visibility = BottomNavigationView.VISIBLE
    }
