...
val DIFFICULTY_LEVELS = listOf("Easy", "Normal", "Hard")
...
class MainFragment : Fragment(R.layout.fragment_main) {
    ...
    private fun addRow(container: LinearLayout, index: Int) {
        ...
        row.forEach {
            ...
            wordLabel.setTextColor(resources.getColor(R.color.white))
    ...
    private fun getWordRow(): ArrayList<String> {
        ...
        while (length < AVG_CHARACTERS_PER_ROW) {
            ...
            if (randomWord != lastWord && randomWord.length >= minWordLength) {
